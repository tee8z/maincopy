...
pub(super) async fn index(State(reader): State<SiteSnapshotReader>) -> Response {
    let snapshot = reader.load_full();
    html_response(StatusCode::OK, snapshot.index_page())
}

pub(super) async fn post(
    State(reader): State<SiteSnapshotReader>,
...
pub(super) async fn archive(State(reader): State<SiteSnapshotReader>) -> Response {
    let snapshot = reader.load_full();
...
pub(super) async fn not_found(State(reader): State<SiteSnapshotReader>) -> Response {
    let snapshot = reader.load_full();
    not_found_response(&snapshot)
}

pub(super) async fn method_not_allowed(State(reader): State<SiteSnapshotReader>) -> Response {
    let snapshot = reader.load_full();
    html_response(
